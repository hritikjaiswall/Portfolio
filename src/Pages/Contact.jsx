...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await fetch("https://formsubmit.co/111rjaiswal@gmail.com", {
        method: "POST",
    ...
    <>
      ...
      <div className="h-auto py-10 flex items-center justify-center px-[5%] md:px-0" id="Contact">
        <div className="container px-[1%] grid grid-cols-1 lg:grid-cols-[45%_55%] 2xl:grid-cols-[35%_65%] gap-12">
          ...
          {/* Contact Form */}
          <div data-aos="fade-right" data-aos-duration="1200" className="bg-white/5 backdrop-blur-xl rounded-3xl shadow-2xl p-5 py-10 sm:p-10 hover:shadow-[#6366f1]/10 transition-all duration-300">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div data-aos="fade-up" data-aos-delay="100" className="relative group">
                ...
                <input
                  ...
                  className="w-full p-4 pl-12 bg-white/10 rounded-xl border border-white/20 placeholder-gray-500 text-white focus:outline-none focus:ring-2 focus:ring-[#6366f1]/30 hover:border-[#6366f1]/30 disabled:opacity-50"
                />
              </div>
              ...
              <div data-aos="fade-up" data-aos-delay="300" className="relative group">
                ...
                <textarea
                  ...
                  required
                  disabled={isSubmitting}
                  className="w-full resize-none p-4 pl-12 bg-white/10 rounded-xl border border-white/20 placeholder-gray-500 text-white h-[9.9rem] focus:outline-none focus:ring-2 focus:ring-[#6366f1]/30 hover:border-[#6366f1]/30 disabled:opacity-50"
                />
              </div>
          ...
          {/* Comments Section */}
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-3 md:p-10 shadow-2xl hover:shadow-[#6366f1]/10 transition-all duration-300">
            <Komentar />
          </div>
