...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/hritikjaiswall",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@hritikjaiswall",
    icon: Instagram,
    url: "https://www.instagram.com/hritikjaiswall",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@hritikjaiswall",
    icon: Youtube,
    url: "https://www.youtube.com/@hritikjaiswall",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "hritikjaiswall",
    icon: Github,
    url: "https://github.com/hritikjaiswall",
    color: "#ffffff",
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
          <a
            ...
            className="group relative flex items-center gap-3 p-4 rounded-xl bg-white/5 border border-white/10 overflow-hidden hover:border-white/20 transition-all duration-500"
          >
            <div className={`absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500 bg-gradient-to-r ${github.gradient}`} />
            <div className="relative flex items-center justify-center">
              <div className="absolute inset-0 opacity-20 rounded-lg transition-all duration-500 group-hover:scale-125 group-hover:opacity-30" style={{ backgroundColor: github.color }} />
              <div className="relative p-2 rounded-lg">
                <github.icon className="w-5 h-5 transition-all duration-500 group-hover:scale-110" style={{ color: github.color }} />
              </div>
            </div>
            <div className="flex flex-col min-w-0">
              <span className="text-sm font-bold text-gray-200 group-hover:text-white transition-colors duration-300">
